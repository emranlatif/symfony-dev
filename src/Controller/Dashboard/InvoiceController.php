...
class InvoiceController extends AbstractController
{
    ...
    #[Route(path: ['en' => '/dashboard/facturen', 'nl' => '/dashboard/facturen', 'fr' => '/dashboard/facturen'], name: 'dashboard_facturen')]
...
//        $qb->setParameter('userId', $user->getId());
    ...
    #[Route(path: ['en' => '/dashboard/facturen/{invoice}', 'nl' => '/dashboard/facturen/{invoice}', 'fr' => '/dashboard/facturen/{invoice}'], name: 'dashboard_facturen_download')]
    public function download(
        ...
        int $invoice, EntityManagerInterface $entityManager
    )
    {
